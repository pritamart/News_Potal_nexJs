        ...
        <div className="px-8 flex justify-between items-center relative h-[48px]">
          ...
          <div className=" h-full w-[48px]">
            <div
              ...
              className={` text-xl ${
                show ? "bg-[#00000026]" : ""
              } font-bold h-full w-full cursor-pointer
                ...
                <div className="flex">
                  <div className="w-full max-w-[calc(100% - 45px)] h-[40px]">
                    <input
                      type="text"
                      placeholder="search"
                      className="h-full w-full p-2 border 
                  border-slate-300 outline-none bg-slate-100"
                    />
                  </div>
                  <div
                    className="w-[45px] h-[40px] hover:bg-red-700 cursor-pointer flex 
                justify-center items-center bg-red-600 text-white text-xl"
                  >
                    <AiOutlineSearch />
                  </div>
                </div>
